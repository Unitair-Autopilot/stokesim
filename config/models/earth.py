"""
Environment configuration (geoid, atmos, magneto, and octree) that
mimics good-ol' planet Earth. Only requires you to set Geoid::enu0_lla.
Be sure to modify the wind to your liking as well.
...
geoid = {
    ...
    "u": 3986004.418e8,  # gravitational constant, m^3/s^2
    "c20": -1082.63e-6,  # geopotential coefficient
    "w": [0, 0, 7.292e-5],  # angular velocity of ECEF frame relative to ECI frame, rad/s
    "enu0_lla": None  # LLA of ENU origin, deg & m
}

##################################################

atmos = {
    "P0": 101.325e3,  # sea level standard pressure, Pa
    "T0": 288.15,  # sea level standard temperature, K
    "L": 0.0065,  # temperature lapse rate, K/m
    "R": 8.31447,  # ideal gas constant, J/(mol*K)
    "M": 0.0289644,   # molar mass of dry air, kg/mol
    "g": 9.80665,  # standard gravity, m/s^2
    "rho": 1023.6,  # density of ocean, kg/m^3
    "wind_mean": [0, 0, 0],  # uniform wind mean velocity in local ENU coordinates, m/s
    "turb_taus": [30, 30, 10],  # time-constants measuring the mean-return tendency of the wind field, s
    "turb_covar": np.diag(np.square([0, 0, 0])).tolist()  # wind turbulence random walk covariance matrix, (m/s)^2
}

##################################################

magneto = {
    "wmm_cof":  # string containing the exact content of a standard NOAA WMM.COF file
"""\
...
octree = {
    "ground_alt": None  # altitude of ground surface, m
}
